$('.ui-columntoggler-items').hide();
var breaker = 0;
var reBuildDataTable = function () {
    try {
        if (window.hasOwnProperty('PF') != null) {
            ...
            setTimeout(function () {
                $('.ui-columntoggler-items').find('label').each(function () {
                    var tmpHtml = $(this).html();
                    if (tmpHtml.toString().indexOf('$(function()') != -1) {
                        tmpHtml = tmpHtml.split('$(function()')[0].trim();
                        $(this).html(tmpHtml);
                    }
                    if (tmpHtml.toString().indexOf('PrimeFaces') != -1) {
                        tmpHtml = tmpHtml.split('PrimeFaces')[0].trim();
                        $(this).html(tmpHtml);
                    }

                });

                $('.ui-columntoggler-items').show();
            }, 500);
